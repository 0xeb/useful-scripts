...
if sys.platform != "win32":
    raise ImportError(
        ...
        "(uses Win32 Debug API via ctypes); current platform: "
        + sys.platform
    )
...
from ctypes import (
    POINTER, Structure, Union, byref, c_byte, c_char, c_double, c_int,
    c_int64, c_long, c_short, c_size_t, c_ubyte, c_uint, c_uint16, c_uint32,
    c_uint64, c_ulong, c_ulonglong, c_void_p, c_wchar, c_wchar_p, sizeof,
    windll,
)
...
EVENT_NAMES = {
    1: "EXCEPTION", 2: "CREATE_THREAD", 3: "CREATE_PROCESS",
...
EXCEPTION_NAMES = {
    ...
    0xC0000094: "INTEGER_DIVIDE_BY_ZERO", 0xC0000096: "PRIV_INSTRUCTION",
    0xC00000FD: "STACK_OVERFLOW",
    0x4000001F: "WX86_BREAKPOINT", 0x4000001E: "WX86_SINGLE_STEP",
}
...
CONTEXT_ALL                 = (CONTEXT_FULL | CONTEXT_FLOATING_POINT
...
class XMM_SAVE_AREA32(Structure):
    _fields_ = [
        ("ControlWord", c_uint16), ("StatusWord", c_uint16),
        ("TagWord", c_ubyte), ("Reserved1", c_ubyte),
        ("ErrorOpcode", c_uint16),
        ("ErrorOffset", c_uint32), ("ErrorSelector", c_uint16),
        ("Reserved2", c_uint16),
        ("DataOffset", c_uint32), ("DataSelector", c_uint16),
        ("Reserved3", c_uint16),
...
class CONTEXT(Structure):
    ...
    _fields_ = [
        ...
        ("SegCs", c_uint16), ("SegDs", c_uint16),
        ("SegEs", c_uint16), ("SegFs", c_uint16),
        ("SegGs", c_uint16), ("SegSs", c_uint16),
        ("EFlags", c_uint32),
        ("Dr0", c_uint64), ("Dr1", c_uint64), ("Dr2", c_uint64),
        ("Dr3", c_uint64), ("Dr6", c_uint64), ("Dr7", c_uint64),
        ("Rax", c_uint64), ("Rcx", c_uint64), ("Rdx", c_uint64),
        ("Rbx", c_uint64), ("Rsp", c_uint64), ("Rbp", c_uint64),
        ("Rsi", c_uint64), ("Rdi", c_uint64),
        ("R8",  c_uint64), ("R9",  c_uint64), ("R10", c_uint64),
        ("R11", c_uint64), ("R12", c_uint64), ("R13", c_uint64),
...
INTEGER_REGS = ("Rax","Rcx","Rdx","Rbx","Rsp","Rbp","Rsi","Rdi",
...
WOW64_CONTEXT_FULL = (WOW64_CONTEXT_CONTROL | WOW64_CONTEXT_INTEGER
                      | WOW64_CONTEXT_SEGMENTS)
WOW64_CONTEXT_ALL = (WOW64_CONTEXT_FULL | WOW64_CONTEXT_FLOATING_POINT
...
class WOW64_FLOATING_SAVE_AREA(Structure):
    _fields_ = [
        ("ControlWord", c_uint32), ("StatusWord", c_uint32),
        ("TagWord", c_uint32), ("ErrorOffset", c_uint32),
        ("ErrorSelector", c_uint32), ("DataOffset", c_uint32),
...
class WOW64_CONTEXT(Structure):
    _fields_ = [
        ...
        ("Dr0", c_uint32), ("Dr1", c_uint32), ("Dr2", c_uint32),
        ("Dr3", c_uint32), ("Dr6", c_uint32), ("Dr7", c_uint32),
        ("FloatSave", WOW64_FLOATING_SAVE_AREA),
        ("SegGs", c_uint32), ("SegFs", c_uint32),
        ("SegEs", c_uint32), ("SegDs", c_uint32),
        ("Edi", c_uint32), ("Esi", c_uint32),
        ("Ebx", c_uint32), ("Edx", c_uint32),
        ("Ecx", c_uint32), ("Eax", c_uint32),
        ("Ebp", c_uint32), ("Eip", c_uint32),
        ("SegCs", c_uint32), ("EFlags", c_uint32),
        ("Esp", c_uint32), ("SegSs", c_uint32),
...
class CREATE_PROCESS_DEBUG_INFO(Structure):
    _fields_ = [
        ...
        ("lpThreadLocalBase", c_void_p),
        ("lpStartAddress", c_void_p),
        ("lpImageName", c_void_p), ("fUnicode", c_uint16),
    ]
...
class LOAD_DLL_DEBUG_INFO(Structure):
    _fields_ = [
        ("hFile", HANDLE), ("lpBaseOfDll", c_void_p),
        ("dwDebugInfoFileOffset", c_uint32),
        ("nDebugInfoSize", c_uint32),
        ("lpImageName", c_void_p), ("fUnicode", c_uint16),
    ]
...
class OUTPUT_DEBUG_STRING_INFO(Structure):
    _fields_ = [("lpDebugStringData", c_void_p),
                ("fUnicode", c_uint16),
...
k32.CreateProcessW.argtypes = [c_wchar_p, c_wchar_p, c_void_p, c_void_p,
                               wt.BOOL, c_uint32, c_void_p, c_wchar_p,
...
k32.ReadProcessMemory.argtypes = [HANDLE, c_void_p, c_void_p, c_size_t,
                                  POINTER(c_size_t)]
k32.ReadProcessMemory.restype = wt.BOOL
k32.WriteProcessMemory.argtypes = [HANDLE, c_void_p, c_void_p, c_size_t,
                                   POINTER(c_size_t)]
...
class THREADENTRY32(Structure):
    _fields_ = [
        ("dwSize", c_uint32), ("cntUsage", c_uint32),
        ("th32ThreadID", c_uint32), ("th32OwnerProcessID", c_uint32),
        ("tpBasePri", c_long), ("tpDeltaPri", c_long),
        ("dwFlags", c_uint32),
    ]
...
class _DbgImpl:
    ...
    def spawn(self, path: str, args: str = "") -> dict:
        if self.attached or self.spawned:
            raise RuntimeError("already attached/spawned; call kill() or detach() first")
        si = STARTUPINFOW(); si.cb = sizeof(STARTUPINFOW)
        pi = PROCESS_INFORMATION()
        cmdline = f'"{path}"' + (f" {args}" if args else "")
        flags = DEBUG_PROCESS | DEBUG_ONLY_THIS_PROCESS | CREATE_NEW_CONSOLE
        ok = k32.CreateProcessW(path, ctypes.c_wchar_p(cmdline), None, None,
                                False, flags, None, None, byref(si), byref(pi))
        if not ok:
        ...
        self._detect_wow64()
        return {
            "pid": self.pid, "tid": pi.dwThreadId,
    ...
    def attach(self, pid: int) -> dict:
        ...
        return {"pid": self.pid, "wow64": self._wow64,
                "reconciled_threads": added, "first_event": first}
    ...
    def _cleanup_handles(self):
        ...
        self._threads.clear()
        if self.h_process:
            try: k32.CloseHandle(self.h_process)
            except Exception: pass
        self.h_process = 0
        self.pid = 0
    ...
    def wait(self, timeout_ms: int = 500) -> dict:
        ...
        if code == CREATE_PROCESS_DEBUG_EVENT:
            ...
            self._threads[tid] = {
                "tid": tid, "handle": cp.hThread,
                "start_address": start_addr, "is_main": True,
                "created_at": _now_ms(), "created_seq": seq,
                "discovered": False,
            }
            ...
            info.update({"image_base": base, "image_path": path,
                         "entry": start_addr,
            ...
            self._threads[tid] = {
                "tid": tid, "handle": ct.hThread,
                "start_address": start_addr, "is_main": False,
                "created_at": _now_ms(), "created_seq": seq,
                "discovered": False,
            }
            ...
            if entry and entry.get("handle"):
                try: k32.CloseHandle(entry["handle"])
                except Exception: pass
            ...
            m = self._modules.get(base, {})
            info.update({"base": base, "path": path,
                         "size": m.get("size"), "entry": m.get("entry")})
            ...
            self._unloaded_modules.append({
                ...
                "lifetime_ms": (
                    now - mod["loaded_at"]
                    if mod and mod.get("loaded_at") is not None else None
                ),
            })
            ...
            info.update({
                ...
                "code": ec, "address": addr, "first_chance": first_chance,
            })
    ...
    def _continue_last(self, status: int = DBG_CONTINUE):
        if self._last_event is None: return
        if not self._last_event.get("_pending_continue"): return
        ev = self._last_event
    ...
    def _resume_past_bp_if_needed(self) -> dict | None:
        ...
        while True:
            ...
            if (ev["event"] == "EXCEPTION"
                    and ev.get("code") in (EXCEPTION_SINGLE_STEP,
    ...
    def cont(self, timeout_ms: int = 2000,
        ...
        if rearm_ev is not None:
            ...
            if handled is None:
                self._continue_last(DBG_CONTINUE if self._is_handled()
                                    else DBG_EXCEPTION_NOT_HANDLED)
            else:
                self._continue_last(DBG_CONTINUE if handled
                                    else DBG_EXCEPTION_NOT_HANDLED)
        while True:
    ...
    def set_bp(self, addr, condition: str | None = None,
               action: str | None = None, name: str | None = None) -> dict:
        ...
        if cerr:
            return {"set": False, "reason": "condition_syntax_error",
                    "addr": addr, "error": cerr}
        if aerr:
            return {"set": False, "reason": "action_syntax_error",
                    "addr": addr, "error": aerr}
        self._write_bytes(addr, b"\xCC", flush=True)
        entry = {
            "addr": addr, "orig": orig, "name": name,
            "condition": condition, "condition_compiled": cc,
            "action": action, "action_compiled": ac,
            "hits": 0, "skipped": 0, "state": {},
        }
    ...
    def clear_bp(self, addr) -> dict:
        ...
        return {
            "cleared": True, "addr": addr, "orig": entry["orig"],
            "name": entry.get("name"),
    ...
    def list_bps(self) -> list:
        ...
        for addr in sorted(self._bps):
            ...
            if sym and "name" in sym:
                row["symbol"] = f"{sym['module']}!{sym['name']}+{sym.get('offset',0):#x}"
            out.append(row)
        return out
    ...
    def set_hw_bp(self, addr_or_symbol, type: str = "x", size: int = 1,
                  ...
                  name: str | None = None, slot: int | None = None,
                  threads: list | None = None) -> dict:
        ...
        if self._wow64 and addr >= (1 << 32):
            return {"set": False, "reason": "addr_above_4gb",
        ...
        if slot is None:
            for s in range(4):
                if s not in self._hw_bps:
                    slot = s; break
            if slot is None:
                return {"set": False, "reason": "no_slot_available",
                        "detail": "all 4 hardware BP slots are in use"}
        else:
            slot = int(slot)
            if not 0 <= slot < 4:
                return {"set": False, "reason": "bad_slot",
        ...
        entry = {
            "slot": slot, "addr": addr, "type": type, "size": size,
            "name": name,
            "condition": condition, "condition_compiled": cc,
            "action": action, "action_compiled": ac,
            "hits": 0, "skipped": 0, "state": {},
        ...
        target_tids = thread_filter if thread_filter is not None else list(self._threads)
        applied = []
        errors = {}
        ...
        if action: out["action"] = action
        if sym: out["symbol"] = sym
        if errors: out["apply_errors"] = errors
        return out
    ...
    def clear_hw_bp(self, addr_or_slot) -> dict:
        ...
        BP was applied to."""
        target_slot = None
        if isinstance(addr_or_slot, int) and 0 <= addr_or_slot < 4 and addr_or_slot in self._hw_bps:
        ...
        for tid in target_tids:
            try:
                ...
                pass
        return {
            "cleared": True, "slot": target_slot, "addr": entry["addr"],
    ...
    def _apply_hw_bps_to_thread(self, tid: int) -> None:
        ...
        for slot in range(4):
            ...
            applies = (e is not None
                       and (e.get("threads") is None
                            or tid in e["threads"]))
            if applies:
    ...
    def _compile_bp_scripts(self, condition, action, addr):
        ...
        cerr = aerr = None
        if condition:
            try: cc = compile(condition, f"<bp@{addr:#x}.condition>", "eval")
            except SyntaxError as e: cerr = f"{type(e).__name__}: {e}"
        if action:
            try: ac = compile(action, f"<bp@{addr:#x}.action>", "exec")
            except SyntaxError as e: aerr = f"{type(e).__name__}: {e}"
    ...
    def _eval_bp_scripts(self, ev: dict) -> tuple:
        ...
        meta = {"addr": addr, "name": bp.get("name"),
                "hits": bp["hits"], "kind": kind}
        if kind == "hw":
    ...
    def _open_thread(self, tid: int) -> int:
        ...
        self._threads[tid] = {
            "tid": tid, "handle": h,
            "start_address": 0, "is_main": False,
            "created_at": _now_ms(), "created_seq": None,
            "discovered": True,
        }
        return h
    ...
    def read_mem(self, addr: int, n: int) -> dict:
        buf = (c_ubyte * int(n))()
        got = c_size_t(0)
        if not k32.ReadProcessMemory(self.h_process, c_void_p(int(addr)),
                                     buf, int(n), byref(got)):
            raise _winerror("ReadProcessMemory")
        data = bytes(buf[: got.value])
        return {"addr": int(addr), "size": got.value, "hex": data.hex()}

    def write_mem(self, addr: int, hexbytes: str | bytes,
    ...
    def read_u8 (self, addr): return self.read_int(addr, 1, False)
    def read_u16(self, addr): return self.read_int(addr, 2, False)
    def read_u32(self, addr): return self.read_int(addr, 4, False)
    def read_u64(self, addr): return self.read_int(addr, 8, False)
    def read_i8 (self, addr): return self.read_int(addr, 1, True)
    def read_i16(self, addr): return self.read_int(addr, 2, True)
    def read_i32(self, addr): return self.read_int(addr, 4, True)
    def read_i64(self, addr): return self.read_int(addr, 8, True)
    def read_ptr(self, addr): return self.read_int(addr, 8, False)
    ...
    def write_int(self, addr: int, value: int, size: int = 8,
                  signed: bool = False) -> dict:
        data = int(value).to_bytes(int(size), "little", signed=signed)
        return self.write_mem(int(addr), data)

    def write_u8 (self, addr, v): return self.write_int(addr, v, 1, False)
    def write_u16(self, addr, v): return self.write_int(addr, v, 2, False)
    def write_u32(self, addr, v): return self.write_int(addr, v, 4, False)
    def write_u64(self, addr, v): return self.write_int(addr, v, 8, False)
    def write_i8 (self, addr, v): return self.write_int(addr, v, 1, True)
    def write_i16(self, addr, v): return self.write_int(addr, v, 2, True)
    def write_i32(self, addr, v): return self.write_int(addr, v, 4, True)
    def write_i64(self, addr, v): return self.write_int(addr, v, 8, True)
    def write_ptr(self, addr, v): return self.write_int(addr, v, 8, False)
    ...
    def _write_bytes(self, addr: int, data: bytes, flush: bool = False):
        ...
        if not k32.WriteProcessMemory(self.h_process, c_void_p(int(addr)),
                                      buf, len(data), byref(wrote)):
            raise _winerror("WriteProcessMemory")
        if flush:
            k32.FlushInstructionCache(self.h_process, c_void_p(int(addr)),
                                      len(data))
    ...
    def entry_points(self) -> list:
        ...
        """
        import pefile
        exe = next((m for m in self._modules.values()
                    if m["name"].lower().endswith(".exe")), None)
    ...
    # ---------------- modules ----------------
    def _add_module(self, base: int, path: str, seq: int,
        ...
        try:
            ...
            if hasattr(pe, "DIRECTORY_ENTRY_EXPORT"):
                for e in pe.DIRECTORY_ENTRY_EXPORT.symbols:
                    name = (e.name.decode("ascii", "replace")
                            if e.name else None)
                    fwd = (e.forwarder.decode("ascii", "replace")
                           if e.forwarder else None)
                    out.append({
            ...
            if hasattr(pe, "DIRECTORY_ENTRY_IMPORT"):
                for d in pe.DIRECTORY_ENTRY_IMPORT:
                    ...
                    for imp in d.imports:
                        iat_rva = (int(imp.address) - preferred
                                   if imp.address else 0)
                        out.append({
                            "module": dll,
                            "name": (imp.name.decode("ascii", "replace")
                                     if imp.name else None),
                            "ordinal": (int(imp.ordinal)
                                        if imp.ordinal else None),
                            "iat_rva": iat_rva,
                            "iat_addr": (run_base + iat_rva
                                         if imp.address else 0),
                        })
            pe.close()
            m["imports"] = out
    ...
    def list_modules(self, with_exports: bool = False,
        ...
        for m in sorted(self._modules.values(), key=lambda x: x["base"]):
            row = {k: m[k] for k in (
                "base", "name", "path", "size", "entry_rva", "entry",
                "is_image", "machine", "timestamp", "loaded_at", "loaded_seq",
            ) if k in m}
            if "pe_error" in m:
    ...
    def module_info(self, key, with_exports: bool = False,
                    with_imports: bool = False) -> dict | None:
    ...
    def _lookup_module(self, key) -> dict | None:
        ...
        if cand:
            return cand[0]
        if kl.startswith("0x"):
            try: return self._modules.get(int(kl, 16))
    ...
    def _public_exports(self, m: dict) -> list:
        ...
        return [
            {"name": e["name"], "ordinal": e["ordinal"],
             "rva": e["rva"], "addr": (base + e["rva"]) if e["rva"] else 0,
    ...
    def _resolve_in(self, m: dict, sym: str, follow_forwarders: bool,
                    seen: set) -> int:
        base = int(m["base"])
        key = (base, sym)
        if key in seen:
        ...
        target_ord = None
        if sym.startswith("#"):
            try: target_ord = int(sym[1:])
            except ValueError: target_ord = None
        for e in m.get("exports", []):
            match = ((e.get("name") == sym)
                     or (target_ord is not None
                         and e.get("ordinal") == target_ord))
            if not match:
                continue
            if e.get("forwarder"):
                ...
                if "." in tgt:
                    ...
                    tm = (self._lookup_module(tmod)
                          or self._lookup_module(tmod + ".dll"))
                    if tm is None:
                        return 0
    ...
    def suspend_thread(self, tid: int) -> dict:
        ...
        return {"tid": int(tid), "prev_count": int(prev),
                "count": int(prev) + 1}
    ...
    def _is_handled(self) -> bool:
        ...
        if ev.get("event") != "EXCEPTION":
            return True
        code = ev.get("code")
        if code in (EXCEPTION_BREAKPOINT, EXCEPTION_SINGLE_STEP,
    ...
    def _is_internal(self, ev: dict) -> bool:
        if ev.get("event") in ("LOAD_DLL", "UNLOAD_DLL", "CREATE_THREAD",
                               "EXIT_THREAD", "OUTPUT_DEBUG_STRING"):
            return True
        if ev.get("loader_bp"):
            return True
...
class Debugger:
    ...
    _PROXY_METHODS = (
        "spawn", "attach", "detach", "kill",
        "wait", "continue_event", "cont", "step", "step_over",
        "set_bp", "clear_bp", "list_bps",
        "set_hw_bp", "clear_hw_bp", "list_hw_bps",
        "get_regs", "set_reg",
        "read_mem", "write_mem",
        "read_int", "read_u8", "read_u16", "read_u32", "read_u64",
        "read_i8", "read_i16", "read_i32", "read_i64",
        "read_ptr", "read_f32", "read_f64",
        "read_cstr", "read_wstr",
        "write_int", "write_u8", "write_u16", "write_u32", "write_u64",
        "write_i8", "write_i16", "write_i32", "write_i64",
        "write_ptr", "write_f32", "write_f64",
        "write_cstr", "write_wstr",
        "assemble", "write_asm",
        "disasm",
        "entry_points", "break_on_entry_points",
        "list_modules", "module_info",
        "module_exports", "module_imports", "module_history",
        "resolve", "addr_to_symbol",
        "list_threads", "thread_info", "thread_history",
        "suspend_thread", "resume_thread",
        "suspend_all", "resume_all",
        "current_thread", "event_info", "version",
    )
    ...
    def __init__(self):
        ...
        self._t = threading.Thread(
            target=_dbg_worker_loop, args=(self._q, self._impl),
            name="dbg-worker", daemon=True,
        )
        self._t.start()
